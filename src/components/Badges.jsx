...
import photoJung from "../assets/images/jung-photo.fw.png"
import typeFe from "../assets/images/hover-avatar-fe.fw.png"
import typeFi from "../assets/images/hover-avatar-fi.fw.png"
import typeTe from "../assets/images/hover-avatar-te.fw.png"
import typeTi from "../assets/images/hover-avatar-ti.fw.png"
import typeSe from "../assets/images/hover-avatar-se.fw.png"
import typeSi from "../assets/images/hover-avatar-si.fw.png"
import typeNe from "../assets/images/hover-avatar-ne.fw.png"
import typeNi from "../assets/images/hover-avatar-ni.fw.png"


function Badges({ url, index, numCode, role, size, display }) {
  ...
  return (
    <div className="badges" style={{display: `${display}`}}>
        ...
        {(url === "as4l" && numCode === 10 && role === "couple") ? <img style={{width: '380px'}} src={null} alt="ESFP"/> : null}        
        {/*Mini badges:*/}
        ...
        {/*8 para "jung"*/}        
        {(url === "jung" && numCode === "100" && role === "Fe") ? <img src={typeFe} alt="~"/> : null}
        {(url === "jung" && numCode === "100" && role === "Fi") ? <img src={typeFi} alt="~"/> : null}
        {(url === "jung" && numCode === "100" && role === "Te") ? <img src={typeTe} alt="~"/> : null}
        {(url === "jung" && numCode === "100" && role === "Ti") ? <img src={typeTi} alt="~"/> : null}
        {(url === "jung" && numCode === "100" && role === "Se") ? <img src={typeSe} alt="~"/> : null}
        {(url === "jung" && numCode === "100" && role === "Si") ? <img src={typeSi} alt="~"/> : null}
        {(url === "jung" && numCode === "100" && role === "Ne") ? <img src={typeNe} alt="~"/> : null}
