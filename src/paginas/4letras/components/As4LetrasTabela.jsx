            ...
            <div className="as4letraschosen-desktop-grid">
                ...
                <div className="as4letraschosen-desktop-tabela">
                  <div className="as4letraschosen-desktop-table-up">
                    ...
                    <div className={`f1`+` `+`${as4letraschosenfunctions[0].f1}`}><Link style={{textDecoration: 'none', color: 'inherit'}} to={`/t/fn/${as4letraschosenfunctions[0].f1}`}>{as4letraschosenfunctions[0].f1}</Link></div>
                    <div className={`f2`+` `+`${as4letraschosenfunctions[0].f2}`}><Link style={{textDecoration: 'none', color: 'inherit'}} to={`/t/fn/${as4letraschosenfunctions[0].f2}`}>{as4letraschosenfunctions[0].f2}</Link></div>
                    <div className={`f3`+` `+`${as4letraschosenfunctions[0].f3}`}><Link style={{textDecoration: 'none', color: 'inherit'}} to={`/t/fn/${as4letraschosenfunctions[0].f3}`}>{as4letraschosenfunctions[0].f3}</Link></div>
                    <div className={`f4`+` `+`${as4letraschosenfunctions[0].f4}`}><Link style={{textDecoration: 'none', color: 'inherit'}} to={`/t/fn/${as4letraschosenfunctions[0].f4}`}>{as4letraschosenfunctions[0].f4}</Link></div>             
                ...
                <div className={`f5`+` `+`${as4letraschosenfunctions[0].f5}`}><Link style={{textDecoration: 'none', color: 'inherit'}} to={`/t/fn/${as4letraschosenfunctions[0].f5}`}>{as4letraschosenfunctions[0].f5}</Link></div>
                <div className={`f6`+` `+`${as4letraschosenfunctions[0].f6}`}><Link style={{textDecoration: 'none', color: 'inherit'}} to={`/t/fn/${as4letraschosenfunctions[0].f6}`}>{as4letraschosenfunctions[0].f6}</Link></div>
                <div className={`f7`+` `+`${as4letraschosenfunctions[0].f7}`}><Link style={{textDecoration: 'none', color: 'inherit'}} to={`/t/fn/${as4letraschosenfunctions[0].f7}`}>{as4letraschosenfunctions[0].f7}</Link></div>
                <div className={`f8`+` `+`${as4letraschosenfunctions[0].f8}`}><Link style={{textDecoration: 'none', color: 'inherit'}} to={`/t/fn/${as4letraschosenfunctions[0].f8}`}>{as4letraschosenfunctions[0].f8}</Link></div>
